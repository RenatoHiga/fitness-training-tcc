	...
	<body class="yellow darken-4 center-align">
		<div class="container col m10 l12">
			...
			<div class="row" id="container_all">
				...
				<div class="row"><h1 class="center-align"  id="title">Painel do Administrador</h1></div>
				...
				<div class="col m10 l12">
					...
					<div class="row input_login">
						...
						<div class="input-field col s12 center-align">
							<input type="email" id="txt_userName">
							<label for="txt_userName">Nome de Usuário do Administrador</label>
						</div>
					...
					<div class="row input_login">
						...
						<div class="input-field col s12">
							<input type="password" class="" id="txt_password">
							<label for="txt_password">Senha do Administrador</label>
						</div>
